...
package object ioutils {
  ...
  def copy(input:InputStream, output:Writer, inputEncoding:Charset=defaultCharset):Unit = IOUtils.copy(input, output, inputEncoding)
  def copy(input:InputStream, output:Writer, inputEncoding:String):Unit = IOUtils.copy(input, output, inputEncoding)
  def copy(input:Reader, output:OutputStream, outputEncoding:Charset=defaultCharset):Unit = IOUtils.copy(input, output, outputEncoding)
  def copy(input:Reader, output:OutputStream, outputEncoding:String):Unit = IOUtils.copy(input, output, outputEncoding)
  ...
  def lineIterator(input:InputStream, encoding:String):LineIterator = IOUtils.lineIterator(input, encoding)
  ...
  def toByteArray(input:Reader, encoding:String):Array[Byte] = IOUtils.toByteArray(input)
  // :
  def toString(input:InputStream, encoding:Charset=defaultCharset):String = IOUtils.toString(input, encoding)
  def toString(input:InputStream, encoding:String):String = IOUtils.toString(input, encoding)
  ...
  // :
  def write(data:String, output:OutputStream, encoding:Charset=defaultCharset):Unit = IOUtils.write(data, output, encoding)
